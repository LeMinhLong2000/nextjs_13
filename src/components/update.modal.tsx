...
interface IProps{
    ...
    setShowModalUpdate: (value: boolean) => void; //hàm không return giá trị nào hết
    blog: IBlog | null;
...
function UpdateModal(props: IProps) {
    ...
    }, [blog])//khi nào có thay đổi thì mới điền thông tin 
    ...
    const handleClose = () =>{
        ...
        setAuthor("");
        setContent("");
        setBlog(null); // trick nhấn 2 lần cùng nút edit
